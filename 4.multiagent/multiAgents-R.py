...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState, action):
        ...
        closestFoodDistance, closestGhostDistance = 1e9, 1e9
        ...
        evalScore = 1/(closestFoodDistance + 1 + 0.1 * closestGhostDistance)     # closer to food and further away from ghost the better
...
class AlphaBetaAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        "*** YOUR CODE HERE ***"
        # util.raiseNotDefined()
        optimalValue, optimalAction = self.value(gameState, 0, self.depth, -1e9, 1e9)
        return optimalAction
